  ...
  return (
    <section className="w-full h-screen z-8">
      <div className="flex flex-col items-center justify-center w-full h-full ">
        <h1 className="text-center text-7xl max-w-prose mb-40">
          Generate Brilliance Mind By Mind.
        </h1>
        <h2 className="text-center text-white/70 mt-3  relative top-8">
          Unleash Your Learning With AI <br />
        </h2>
        <button className="flex items-center justify-center gap-2 px-4 py-2 rounded-full transparentContainer mb-12 ">
          <svg
